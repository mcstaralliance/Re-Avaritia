...
public record SculkCraftingTableCategory(BaseTableCraftingRecipe recipe) implements EmiRecipe {
    private static final EmiTexture TEXTURE = new EmiTexture(ResourceLocation.tryBuild(Static.MOD_ID, "textures/gui/jei/tables/sculk_jei.png"), 0, 0, 116, 55);
    public static final EmiStack WORKSTATION = EmiStack.of(ModBlocks.sculk_crafting_table.get());
    public static final EmiRecipeCategory CATEGORY = new EmiRecipeCategory(ResourceLocation.tryBuild(Static.MOD_ID, "sculk_crafting_table"), WORKSTATION);
